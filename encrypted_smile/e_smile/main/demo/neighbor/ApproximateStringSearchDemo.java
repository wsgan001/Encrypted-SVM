...
import math.Math;
import math.distance.EditDistance;
import neighbor.BKTree;
...
public class ApproximateStringSearchDemo extends JPanel implements Runnable, ActionListener  {
    ...
    public void run() {
        ...
        if (data1 == null) {
            ...
            try {
                FileInputStream stream = new FileInputStream(data.parser.IOUtils.getTestDataFile("index.noun"));
