...
public class HistogramDemo extends JPanel {
    public HistogramDemo() {
        ...
        PlotCanvas canvas = Histogram.plot("Dataset 1", data, math.Histogram.breaks(-6/100., 6/100., 30));
        ...
        canvas.histogram("Dataset 2", data, math.Histogram.breaks(-6/100., 6/100., 30), Color.RED);
