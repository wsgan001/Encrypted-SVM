...
import classification.FLD;
import data.AttributeDataset;
import data.NominalAttribute;
import data.parser.DelimitedTextParser;
import plot.Palette;
    ...
    public void actionPerformed(ActionEvent e) {
        if ("startButton".equals(e.getActionCommand())) {
            ...
            if (dataset[datasetIndex] == null) {
                ...
                try {
                    dataset[datasetIndex] = parser.parse(datasetName[datasetIndex], data.parser.IOUtils.getTestDataFile(datasource[datasetIndex]));
                } catch (Exception ex) {
